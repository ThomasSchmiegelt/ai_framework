...
$BASE_MODELS = @("granite4.2:3b", "ministral-3:3b", "qwen3.5:4b", "qwen2.5vl:3b")   # granite = Standardmodell (config.json default_model); qwen2.5vl = Vision/Bilderkennung; weitere unten abfragbar
